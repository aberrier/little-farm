//
//  BluetoothConnexionViewController.swift
//  LittleFarm
//
...
class BluetoothConnexionViewController : UIViewController, CBCentralManagerDelegate, CBPeripheralDelegate, UITableViewDelegate, UITableViewDataSource{
    ...
    var bluetoothChat : BluetoothChatViewController?
    ...
    @objc func cancelScan() {
        ...
        print("[BLE] Number of Peripherals Found: \(peripherals.count)")
    }
    ...
    func centralManager(_ central: CBCentralManager, didDiscover peripheral: CBPeripheral,advertisementData: [String : Any], rssi RSSI: NSNumber) {
        ...
        self.baseTableView.reloadData()
        if blePeripheral == nil {
            print("[BLE] Found new pheripheral devices with services")
            print("[BLE] Peripheral name: \(String(describing: peripheral.name))")
            print("**********************************")
            print ("[BLE] Advertisement Data : \(advertisementData)")
    ...
    func centralManager(_ central: CBCentralManager, didConnect peripheral: CBPeripheral) {
        ...
        print("[BLE] Peripheral info: \(String(describing: blePeripheral))")
        ...
        bluetoothChat = (storyboard.instantiateViewController(withIdentifier: "BluetoothChat") as! BluetoothChatViewController)
        
        bluetoothChat?.peripheral = peripheral
        bluetoothChat?.previousController = self
        self.present(bluetoothChat!, animated: true)
    }
    ...
    func centralManager(_ central: CBCentralManager, didFailToConnect peripheral: CBPeripheral, error: Error?) {
        if error != nil {
            print("[BLE] Failed to connect to peripheral")
            return
        }
    }
    ...
    func peripheral(_ peripheral: CBPeripheral, didDiscoverServices error: Error?) {
        ...
        print("[BLE] Discovered Services: \(services)")
    }
    ...
    func centralManager(_ central: CBCentralManager, didDisconnectPeripheral peripheral: CBPeripheral, error: Error?) {
        ...
        bluetoothChat?.dismiss(animated: true, completion: nil)
    ...
    func centralManagerDidUpdateState(_ central: CBCentralManager) {
        if central.state == CBManagerState.poweredOn {
            ...
            GT.alert("Bluetooth is not enabled", message: "Make sure that your bluetooth is turned on", sender: self)
