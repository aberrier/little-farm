...
class BluetoothChatViewController: UIViewController, CBPeripheralManagerDelegate, UITextViewDelegate, UITextFieldDelegate {
    //UI
    ...
    //
    var previousController : BluetoothConnexionViewController?
    ...
    @IBAction func goBackToConnexion(_ sender: AnyObject)
    {
        previousController?.disconnectAllConnection()
